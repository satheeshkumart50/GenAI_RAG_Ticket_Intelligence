...
st.markdown("""
    <style>
        ...
        header[data-testid="stHeader"]::before {
            content: "Incident Decision Support - Gemini";
            position: absolute;
            left: 50%;
            top: 50%;
...
FAQ_QUESTIONS = [
    ...
    "List of all INCs currently assigned to group FieldOps?",
    ...
    "What was last INC for node NODE-505?",
...
if user_input:
    ...
    with st.spinner("..."):
        ...
        response = gemini(user_input, session_id=SESSION_ID, max_history_turns=12)
